        ...
        <main className="flex w-full max-w-xl flex-col gap-8 md:max-w-2xl md:gap-10">
            {projects.map((project, index) => {
                ...
                return (
                    <div
                        key={_id}
                        className="flex w-full flex-col gap-6 rounded-sm border-[1px] border-primary-light p-5 transition-colors duration-300 hover:border-secondary-light md:p-7"
                    >
